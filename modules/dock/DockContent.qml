    ...
    MouseArea {
        ...
        Item {
            ...
            RowLayout {
                ...
                // ── App Launcher Button (Arch Linux logo) ──────────────────────
                Button {
                    id: dockLauncherBtn
                    implicitWidth: Config.dock?.iconSize ?? 40
                    implicitHeight: Config.dock?.iconSize ?? 40
                    Layout.alignment: Qt.AlignVCenter

                    background: StyledRect {
                        visible: dockLauncherBtn.hovered || Visibilities.currentActiveModule === "launcher"
                        variant: Visibilities.currentActiveModule === "launcher" ? "primary" : "focus"
                        radius: Styling.radius(-2)
                        enableShadow: false
                        enableBorder: false
                    }
                    ...
                    contentItem: Item {
                        Image {
                            ...
                            width: (Config.dock?.iconSize ?? 40) * 0.55
                            height: (Config.dock?.iconSize ?? 40) * 0.55
                            source: Qt.resolvedUrl("../../assets/arch-linux-logo.svg")
                    ...
                    scale: dockLauncherBtn.pressed ? 0.88 : (dockLauncherBtn.hovered ? 1.08 : 1.0)
                    Behavior on scale {
                        NumberAnimation {
                            duration: dockLauncherBtn.pressed ? 80 : 180
                            easing.type: dockLauncherBtn.pressed ? Easing.OutCubic : Easing.OutBack
            ...
            ColumnLayout {
                ...
                // ── App Launcher Button (Arch Linux logo) vertical ─────────────
                Button {
                    id: dockLauncherBtnV
                    implicitWidth: Config.dock?.iconSize ?? 40
                    implicitHeight: Config.dock?.iconSize ?? 40
                    ...
                    background: StyledRect {
                        visible: dockLauncherBtnV.hovered || Visibilities.currentActiveModule === "launcher"
                        variant: Visibilities.currentActiveModule === "launcher" ? "primary" : "focus"
                        radius: Styling.radius(-2)
                        enableShadow: false
                        enableBorder: false
                    ...
                    scale: dockLauncherBtnV.pressed ? 0.88 : (dockLauncherBtnV.hovered ? 1.08 : 1.0)
                    Behavior on scale {
                        NumberAnimation {
                            duration: dockLauncherBtnV.pressed ? 80 : 180
                            easing.type: dockLauncherBtnV.pressed ? Easing.OutCubic : Easing.OutBack
                            easing.overshoot: 1.6
                        }
                    }
