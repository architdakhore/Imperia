...
Rectangle {
    ...
    property bool showSidebar: true   // Set false to use an external sidebar
    ...
    // Original sections model — only includes panels confirmed working
    readonly property var sectionModel: [
        ...
        {
            icon: Qt.resolvedUrl("../../../../assets/imperia/imperia-icon.svg"),
            label: "Imperia",
            section: 7,
            isIcon: false
        },
    ...
    RowLayout {
        ...
        Item {
            ...
            // Panel definitions for Loader — only confirmed-working panels
            readonly property var panelComponents: [
                ...
                {
                    component: "PerformancePanel.qml",
                    section: 8
                },
                {
                    component: "ProcessPanel.qml",
                    section: 9
                }
            ]
