    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            Text {
                ...
                text: player.hasActivePlayer ? (MprisController.activePlayer?.trackTitle ?? "") : ""
            ...
            Text {
                Layout.fillWidth: true
                Layout.preferredHeight: visible ? implicitHeight : 0
                text: player.hasActivePlayer ? (MprisController.activePlayer?.trackAlbum ?? "") : ""
                color: Colors.overBackground
            ...
            Text {
                Layout.fillWidth: true
                Layout.preferredHeight: visible ? implicitHeight : 0
                text: player.hasActivePlayer ? (MprisController.activePlayer?.trackArtist ?? "") : ""
                color: Colors.overBackground
                font.pixelSize: Config.theme.fontSize
                font.family: Config.theme.font
                horizontalAlignment: Text.AlignHCenter
        ...
        RowLayout {
            ...
            opacity: player.hasActivePlayer ? 1.0 : 0.0
            Behavior on opacity {
