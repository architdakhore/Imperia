...
## OVERVIEW
The Dashboard is the central interactive hub of imperia, providing a unified interface for widgets, system controls, media, and AI tools. It uses a high-performance, lazy-loaded tab architecture with LRU-based memory management.
