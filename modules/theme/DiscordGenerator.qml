...
QtObject {
    ...
    function generate(Colors) {
        ...
        let css = `/**
 * @name imperia
 * @description A Discord recolor theme, generated with imperia.
 * @author Axenide
 * @version 1.0.0
 * @invite gHG9WHyNvH
 * @website https://axeni.de/imperia
 * @source https://github.com/Axenide/imperia
...
`
        ...
        const vesktopPath = home + "/.config/vesktop/themes/imperia.css"
