...
## OVERVIEW
The `services/` directory contains the backend logic and system interfaces of imperia. These are primarily Singletons that bridge Wayland protocols, CLI tools (nmcli, upower, etc.), and AI providers to the QML UI layer. 
