...
QtObject {
    ...
    readonly property string appId: "imperia"
    readonly property string ipcPipe: "/tmp/imperia_ipc.pipe"
    ...
    function run(command) {
        ...
        switch (command) {
            ...
            case "controlcenter": GlobalStates.toggleControlCenter(); break;
    ...
    property GlobalShortcut shortcutControlCenter: GlobalShortcut {
        appid: root.appId
        name: "controlcenter"
        description: "Toggle Control Center panel"
        onPressed: GlobalStates.toggleControlCenter()
    }
