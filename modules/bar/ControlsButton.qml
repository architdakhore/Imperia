...
Item {
    ...
    StyledRect {
        ...
        Text {
            ...
            font.pixelSize: 18
            color: root.popupOpen ? buttonBg.item : "#06b6d4"
        }
    ...
    BarPopup {
        ...
        ColumnLayout {
            ...
            ControlSliderRow {
                ...
                progressColor: Audio.sink?.audio?.muted ? Colors.outline : "#10b981"
                wavy: true
            ...
            ControlSliderRow {
                ...
                progressColor: Audio.source?.audio?.muted ? Colors.outline : "#ec4899"
                wavy: true
