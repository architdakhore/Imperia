...
Item {
    ...
    // Only show when battery hardware is present - hide on desktops
    ...
    StyledRect {
        ...
        Text {
            ...
            color: root.popupOpen ? buttonBg.item
                : Battery.available
                    ? (Battery.isPluggedIn ? "#10b981"
                        : (Battery.percentage <= 20 ? "#ef4444"
                            : (Battery.percentage <= 40 ? "#f59e0b" : "#60a5fa")))
                    : Colors.primary
    ...
    BarPopup {
        ...
        contentWidth: Math.max(240, mainColumn.implicitWidth + batteryPopup.popupPadding * 2)
        contentHeight: (Battery.available ? 64 : 0) + batteryPopup.popupPadding * 2
